...
def repair_tool_call(agent, tool_name: str) -> str | None:
    ...
    deepseen_aliases = {
        "deepseen_image_create_and_wait": "deepseen_smart_image_recreations_create_and_wait",
        "deepseen_smart_image_create_and_wait": "deepseen_smart_image_recreations_create_and_wait",
        "deepseen_video_create_and_wait": "deepseen_smart_video_recreations_create_and_wait",
        "deepseen_smart_video_create_and_wait": "deepseen_smart_video_recreations_create_and_wait",
        "deepseen_image_recreation_create_and_wait": "deepseen_image_recreations_create_and_wait",
        "deepseen_video_recreation_create_and_wait": "deepseen_video_recreations_create_and_wait",
        "deepseen_smart_image_recreation_create_and_wait": "deepseen_smart_image_recreations_create_and_wait",
        "deepseen_smart_video_recreation_create_and_wait": "deepseen_smart_video_recreations_create_and_wait",
    }
    ...
    # Deepseen tool names are restricted to an explicit allowlist. Only repair
    # a small set of known aliases instead of using fuzzy matching, so the
    # model cannot silently drift to invented names.
    if normalized.startswith("deepseen_") or lowered.startswith("deepseen_"):
        for c in cands:
            alias_target = deepseen_aliases.get(_norm(c))
