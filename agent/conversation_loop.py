...
from agent.chat_completion_helpers import recover_inline_tool_calls
...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        try:
            ...
            # Recover pseudo tool calls emitted as assistant text before checking
            # the structured tool-call path. This keeps providers like Gemini
            # from silently degrading into narrated JSON / code fences.
