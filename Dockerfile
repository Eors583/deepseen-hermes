...
RUN apt-get update && \
    ...
    ca-certificates curl iputils-ping python3 python-is-python3 ripgrep ffmpeg gcc g++ make python3-dev python3-venv libffi-dev libolm-dev procps git openssh-client docker-cli xz-utils && \
