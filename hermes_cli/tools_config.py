...
CONFIGURABLE_TOOLSETS = [
    ...
    ("deepseen",         "🛒 Deepseen",                  "视频智创 / 图片智创 / 图片二创 / 视频二创"),
]
...
TOOL_CATEGORIES = {
    ...
    "deepseen": {
        ...
        "icon": "",
        "setup_note": (
            "Requires a Deepseen Open API key. Optional base URL overrides "
            "can be set from the Keys page."
        ),
        "providers": [
            {
                "name": "Deepseen Open API",
                "tag": "Cross-border ecommerce image/video creative generation",
                "env_vars": [
                    {
