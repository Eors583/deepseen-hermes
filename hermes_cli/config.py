...
OPTIONAL_ENV_VARS = {
    ...
    "DEEPSEEN_API_KEY": {
        "description": "Deepseen Open API key for ecommerce image/video creative tools",
    ...
    "DEEPSEEN_BASE_URL": {
        "description": "Deepseen Open API base URL override",
        "prompt": "Deepseen base URL (leave empty for default)",
        "url": None,
        "tools": [
            "deepseen_smart_video_recreations_create_and_wait",
            "deepseen_smart_image_recreations_create_and_wait",
