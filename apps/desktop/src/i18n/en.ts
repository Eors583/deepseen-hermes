...
export const en: Translations = {
  ...
  boot: {
    ready: 'Deepseen Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Deepseen settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Deepseen Desktop…'
    },
    errors: {
      backgroundExited: 'Deepseen background process exited.',
      backgroundExitedDuringStartup: 'Deepseen background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Deepseen backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Deepseen',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Deepseen Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Deepseen defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Deepseen follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Deepseen checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Deepseen configuration...',
    ...
    gateway: {
      ...
      intro:
        'Deepseen Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Deepseen backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Deepseen backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Deepseen backend. Hosted gateways use OAuth; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /herbound.',
      ...
      authSignedInPassword:
        'This gateway uses Deepseen authentication. You are signed in; the session refreshes automatically.',
      authSignedInOauth: 'This gateway uses OAuth. You are signed in; the session refreshes automatically.',
      authNeedsPassword: 'This gateway uses Deepseen authentication. Sign in to authorize this desktop app.',
      ...
      restartingMessage: 'Deepseen Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Deepseen ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Deepseen runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Deepseen desktop' },
      skills: { title: 'DeepSeen Capabilities', detail: 'Manage the cross-border commerce agent skills and toolchain' },
      messaging: { title: 'Messaging', detail: 'Set up Telegram, Slack, Discord, and more' },
      artifacts: { title: 'Generated results', detail: 'Browse generated images, files, and downloadable attachments' }
    },
    sectionEntries: {
    ...
    hermesActiveSessions: (version, count) => `Deepseen ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@herbound:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Deepseen environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Deepseen will run it and deliver results to the destination you pick.',
  ...
  artifacts: {
    search: 'Search generated results...',
    refresh: 'Refresh generated results',
    refreshing: 'Refreshing generated results',
    indexing: 'Indexing recent generated results',
    tabAll: 'All',
    tabImages: 'Images',
    tabFiles: 'Attachments',
    tabLinks: 'Links',
    noArtifactsTitle: 'No generated results found',
    noArtifactsDesc: 'Generated images, reports, and downloadable attachments will appear here.',
    failedLoad: 'Generated results failed to load',
    openFailed: 'Open failed',
    itemsImage: 'images',
    itemsLink: 'links',
    itemsFile: 'attachments',
    itemsGeneric: 'items',
    zero: '0',
    rangeOf: (start, end, total) => `${start}-${end} of ${total}`,
    goToPage: (itemLabel, page) => `Go to ${itemLabel} page ${page}`,
    colTitleLink: 'Link title',
    colTitleFile: 'Attachment name',
    colTitleDefault: 'Title / name',
    colLocationLink: 'URL',
    colLocationFile: 'Source / path',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Deepseen...',
    placeholderReconnecting: 'Reconnecting to Deepseen…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Deepseen a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Deepseen will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Deepseen can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Deepseen from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Deepseen will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Deepseen updater will take over in its own window and reopen Deepseen when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Deepseen reconnects automatically when it’s back.',
    applyingClose: 'Deepseen will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Deepseen needs a one-time install',
    ...
    settingUpTitle: 'Setting up Deepseen Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Deepseen CLI or desktop instance is running. Stop any running Deepseen instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Deepseen installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Deepseen Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Deepseen is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Deepseen…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Deepseen',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Deepseen at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Deepseen connects automatically',
      loopback: 'Opens your browser to sign in — Deepseen connects automatically',
    ...
    authorizeThere: 'Authorize Deepseen there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Deepseen there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Deepseen Desktop v${version}`,
      ...
      gatewayTitle: 'Deepseen inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Deepseen will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Deepseen is restarting...',
      askRestart: 'Ask Deepseen to restart the server',
      lookingRestart: taskId => `Deepseen is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Deepseen is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Deepseen finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Deepseen could not restart the server.',
      stillWorking:
        'Deepseen is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Deepseen is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Deepseen gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.herbound/config.yaml). Deepseen won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Deepseen needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Deepseen needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Deepseen Desktop to use Save Image.',
    restartToSaveImages: 'Restart Deepseen Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `herbound gateway` running?'
    }
  },
