...
export const en: Translations = {
  ...
  boot: {
    ready: 'Herbound Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Herbound settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Herbound Desktop…'
    },
    errors: {
      backgroundExited: 'Herbound background process exited.',
      backgroundExitedDuringStartup: 'Herbound background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Herbound backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Herbound',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Herbound Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Herbound defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Herbound follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Herbound checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Herbound configuration...',
    ...
    gateway: {
      ...
      intro:
        'Herbound Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Herbound backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Herbound backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Herbound backend. Hosted gateways use OAuth; self-hosted ones may use a session token.',
      ...
      authSignedInPassword:
        'This gateway uses Herbound authentication. You are signed in; the session refreshes automatically.',
      authSignedInOauth: 'This gateway uses OAuth. You are signed in; the session refreshes automatically.',
      authNeedsPassword: 'This gateway uses Herbound authentication. Sign in to authorize this desktop app.',
      ...
      restartingMessage: 'Herbound Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Herbound ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Herbound runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Herbound ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Herbound environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Herbound will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Herbound...',
    placeholderReconnecting: 'Reconnecting to Herbound…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Herbound a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Herbound will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Herbound can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Herbound from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Herbound will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Herbound updater will take over in its own window and reopen Herbound when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Herbound reconnects automatically when it’s back.',
    applyingClose: 'Herbound will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Herbound needs a one-time install',
    ...
    settingUpTitle: 'Setting up Herbound Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Herbound CLI or desktop instance is running. Stop any running Herbound instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Herbound installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Herbound Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Herbound is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Herbound…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Herbound',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Herbound at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Herbound connects automatically',
      loopback: 'Opens your browser to sign in — Herbound connects automatically',
    ...
    authorizeThere: 'Authorize Herbound there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Herbound there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Herbound Desktop v${version}`,
      ...
      gatewayTitle: 'Herbound inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Herbound will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Herbound is restarting...',
      askRestart: 'Ask Herbound to restart the server',
      lookingRestart: taskId => `Herbound is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Herbound is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Herbound finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Herbound could not restart the server.',
      stillWorking:
        'Herbound is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Herbound is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Herbound gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.herbound/config.yaml). Herbound won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Herbound needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Herbound needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Herbound Desktop to use Save Image.',
    restartToSaveImages: 'Restart Herbound Desktop to save images',
