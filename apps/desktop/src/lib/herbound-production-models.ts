...
export const HERBOUND_PRODUCTION_MODELS: readonly DeepseenProductionModel[] = [
  ...
  { id: 'gpt-5.5', label: 'GPT-5.5 Pro', provider: 'openai-api', aliases: ['gpt-5-5', 'openai/gpt-5.5'] },
  { id: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro', provider: 'openai-api', aliases: ['google/gemini-3.1-pro-preview', 'gemini-3.1-pro'] },
