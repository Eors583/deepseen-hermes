...
configRoutes.get('/api/hermes/config/tool-credentials', ctrl.getToolCredentials)
configRoutes.put('/api/hermes/config/tool-credentials', ctrl.updateToolCredentials)
