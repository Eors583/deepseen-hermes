export default {
  ...
  chat: {
    ...
    openHistory: '開啟歷史',
    hermesHistory: 'Herbound 歷史',
    historyScopeHint: '這裡按來源以唯讀方式查看目前 profile 的 Herbound 歷史工作階段。',
    noSessions: '目前無工作階段',
    searchTitle: '搜尋工作階段',
    searchSubtitle: '依標題或訊息內容搜尋',
    searchScope: '搜尋範圍：僅 Web UI 本地工作階段資料庫；不包含唯讀 Herbound 歷史工作階段。',
  ...
  plugins: {
    title: '插件',
    refresh: '重新整理',
    notice: '唯讀顯示可發現的 Herbound 插件 manifest。發現元資料讀取不會載入插件程式碼。v1 管理動作仍保留在 CLI，新 Herbound 工作階段生效。',
    loadFailed: '載入插件失敗',
    commandCopied: '指令已複製',
  ...
  models: {
    ...
    copilotAddDetected: '已在本機偵測到 GitHub Copilot OAuth 憑證，點擊「新增」即可在 Herbound 中啟用 Copilot。',
    ...
    copilotDeleteHintGhCli: 'Copilot 將從 Herbound 清單移除。不會影響 gh CLI —— `gh auth status` 仍顯示已登入。',
    copilotDeleteHintAppsJson: 'Copilot 將從 Herbound 清單移除。不會影響 VS Code Copilot 插件的登入。',
    customBadge: '自訂',
    previewBadge: '預覽',
    disabledBadge: '不可用',
    ...
    visibilityHint: '僅影響 Web UI 的模型選擇器和模型頁展示，不會改寫 Herbound CLI 的 provider/model 配置。實際呼叫仍使用原始模型 ID。',
    ...
    aliasHint: '僅修改 Web UI 顯示名，傳送給 Herbound 的仍是原始模型 ID。',
  ...
  profiles: {
    ...
    rename: '重新命名',
    delete: '刪除',
    switchTo: '切換 Herbound Profile',
    switchConfirm: '將執行 `hermes profile use {name}` 並切換 Herbound CLI 的 active profile，是否繼續？',
    switchSuccess: 'Herbound active profile 已切換為「{name}」',
    switchFailed: '切換 Herbound Profile 失敗，閘道可能需要手動重新啟動',
  ...
  codingAgents: {
    ...
    codexDescription: "OpenAI CLI，以及 Herbound openai-codex 提供商的倉庫任務流程。",
    copyCommand: "複製",
    commandCopied: "命令已複製",
    ...
    notes: {
      ...
      codexAuth: "新增 Herbound 管理的 OpenAI Codex OAuth 憑證。",
  ...
  skillsUsage: {
    title: '技能用量',
    subtitle: '追蹤 Herbound 工作階段中的技能載入與編輯',
    refresh: '重新整理',
  ...
  changelog: {
    ...
    new_0_6_10_7: '官網文案統一展示為 Herbound，同時保留 npm package、CLI、倉庫和環境變數等技術標識不變',
    new_0_6_10_8: 'OpenAPI 文件補充頭像、輔助模型配置、Provider 模型快取刷新和 Herbound 會話匯入端點',
    ...
    new_0_6_9_1: '應用品牌統一為 Herbound，涵蓋瀏覽器標題、側邊欄、官網標題、package metadata 和官網連結',
    ...
    new_0_6_7_5: 'Desktop 發佈鏈路補齊 Electron 打包、應用命名、preload 建置、release artifact 上傳、Windows Herbound CLI 啟動、Linux 圖示與可寫資料路徑、macOS 無憑證跳過簽名和 Windows 啟動無視窗體驗',
