export default {
  ...
  chat: {
    ...
    contextEditHint: 'Häufige Werte: 256k (Herbound-Standard), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Starten Sie eine Konversation mit Herbound',
    ...
    hermesHistory: 'Herbound-Verlauf',
    historyScopeHint: 'Schreibgeschützte Herbound-Verlaufssitzungen des aktuellen Profils, nach Quelle gruppiert.',
    ...
    searchScope: 'Suchbereich: nur lokale Web-UI-Sitzungsdatenbank; schreibgeschützte Herbound-Verlaufssitzungen sind nicht enthalten.',
...
jobTriggered: 'Job ausgelost',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Aktualisieren',
    notice: 'Schreibgeschütztes Inventar erkennbarer Herbound-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue Herbound-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in Herbound zu aktivieren.',
    ...
    copilotDeleteHintGhCli: 'Copilot wird aus Herbound ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus Herbound ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
    ...
    visibilityHint: 'Wirkt sich nur auf Modellauswahl und Modellseite der Web UI aus. Die provider/model-Konfiguration der Herbound CLI wird nicht geändert; Aufrufe verwenden weiterhin die ursprüngliche Modell-ID.',
    ...
    aliasHint: 'Ändert nur den Anzeigenamen in der Web UI. Herbound erhält weiterhin die ursprüngliche Modell-ID.',
  ...
  profiles: {
    ...
    rename: 'Umbenennen',
    delete: 'Loschen',
    switchTo: 'Herbound Profile wechseln',
    switchConfirm: 'Dies fuehrt `hermes profile use {name}` aus und aendert das aktive Herbound CLI Profile. Fortfahren?',
    switchSuccess: 'Aktives Herbound Profile ist jetzt "{name}"',
    switchFailed: 'Herbound Profile konnte nicht gewechselt werden. Das Gateway muss eventuell manuell neu gestartet werden.',
  ...
  codingAgents: {
    ...
    codexDescription: "OpenAI CLI und Herbound openai-codex Anbieter-Flow fur Repository-Aufgaben.",
    ...
    notes: {
      ...
      codexAuth: "Fugt Herbound-verwaltete OpenAI Codex OAuth-Zugangsdaten hinzu.",
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus Herbound-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  // Anderungsprotokoll
  changelog: {
    new_0_6_10_1: 'Website-Texte zeigen das Produkt jetzt konsistent als Herbound, waehrend npm package, CLI, Repository und Umgebungsvariablen unveraendert bleiben',
    ...
    new_0_6_10_4: 'OpenAPI-Dokumente enthalten jetzt Avatar-, Auxiliary-Model-Config-, Provider-Model-Cache-Refresh- und Herbound-Session-Import-Endpunkte',
    ...
    new_0_6_9_1: 'Die App ist jetzt als Herbound gebrandet, inklusive Browser-Titel, Sidebar, Website-Titel, Package-Metadaten und offiziellen Website-Links',
    ...
    new_0_6_7_5: 'Desktop-Distribution umfasst Electron-Packaging, App-Naming, Preload-Builds, Release-Artifact-Uploads, Windows Herbound CLI Start, Linux-Icons und beschreibbare Datenpfade, macOS ohne Signing-Zertifikate und versteckte Windows-Startup-Subprozesse',
