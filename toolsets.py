...
TOOLSETS = {
    ...
    "browser": {
        "description": "Browser automation tools for UI testing, navigation, and visual inspection.",
        "tools": [
            "browser_navigate",
            "browser_click",
            "browser_type",
    ...
    # ------------------------------------------------------------------
    # Deepseen 跨境电商内容创作工具集
    # 新增工具：在 tools/deepseen_tools.py 注册后此处无需修改；
    # 若需将某工具加入默认 core，追加到 _HERMES_CORE_TOOLS 即可。
    # ------------------------------------------------------------------
    "deepseen": {
        "description": (
            "Deepseen 跨境电商内容创作 — 视频智创、图片智创、图片二创、视频二创。"
        ),
        "tools": [
            "deepseen_smart_video_recreations_create_and_wait",
            "deepseen_smart_image_recreations_create_and_wait",
