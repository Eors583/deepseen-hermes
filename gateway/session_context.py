...
_ENTERPRISE_USER_ID: ContextVar = ContextVar("HERMES_WEB_USER_ID", default=_UNSET)
_ENTERPRISE_ORGANIZATION_ID: ContextVar = ContextVar("HERMES_ENTERPRISE_ORGANIZATION_ID", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_WEB_USER_ID": _ENTERPRISE_USER_ID,
    "HERMES_ENTERPRISE_ORGANIZATION_ID": _ENTERPRISE_ORGANIZATION_ID,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_ID.set(session_id),
        _ENTERPRISE_USER_ID.set(enterprise_user_id),
        _ENTERPRISE_ORGANIZATION_ID.set(enterprise_organization_id),
