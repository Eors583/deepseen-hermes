export default {
  ...
  login: {
    ...
    registerCredentialsRequired: 'Por favor, insira nome de usuario, senha e confirmacao',
    invalidCredentials: 'Nome de usuario ou senha incorretos',
    registerFailed: 'Registro falhou',
    usernameExists: 'Nome de usuario ja existe',
...
jobTriggered: 'Job acionado',
  ...
  githubPreview: {
    ...
    stop: "Parar",
    note: "O código de prévia é armazenado no diretório de dados do Web UI. Produção permanece na porta 9119; a prévia usa frontend 8649 e backend 9119.",
