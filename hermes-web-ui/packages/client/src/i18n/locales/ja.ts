export default {
  ...
  login: {
    ...
    registerCredentialsRequired: 'ユーザー名、パスワード、確認用パスワードを入力してください',
  ...
  githubPreview: {
    ...
    start: "プレビューを開始",
    stop: "停止",
    note: "プレビューコードは Web UI データホーム配下に保存されます。本番は 9119 のまま、プレビュー開発環境はフロントエンド 8649、バックエンド 9119 で実行されます。",
    path: "プレビューパス",
