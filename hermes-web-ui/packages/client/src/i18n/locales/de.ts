export default {
  ...
  login: {
    ...
    registerDescription: 'Registrieren Sie ein Deepseen-Konto, um fortzufahren.',
    registerSubmit: 'Registrieren und anmelden',
    ...
    registerCredentialsRequired: 'Bitte Benutzername, Passwort und Passwortbestatigung eingeben',
...
jobTriggered: 'Job ausgelost',
  ...
  githubPreview: {
    ...
    stop: "Stoppen",
    note: "Der Vorschaucode wird im Web-UI-Datenverzeichnis gespeichert. Produktion bleibt auf Port 9119; die Vorschau nutzt Frontend 8649 und Backend 9119.",
    path: "Vorschaupfad",
