export default {
  ...
  login: {
    ...
    registerDescription: 'Registra una cuenta de Herbound para continuar.',
    registerSubmit: 'Registrarse e iniciar sesion',
    ...
    registerCredentialsRequired: 'Por favor, introduce nombre de usuario, contrasena y confirmacion',
...
jobTriggered: 'Job ejecutado',
  ...
  githubPreview: {
    ...
    stop: "Detener",
    note: "El código de vista previa se guarda bajo el directorio de datos de Web UI. Producción sigue en el puerto 9119; la vista previa usa frontend 8649 y backend 9119.",
