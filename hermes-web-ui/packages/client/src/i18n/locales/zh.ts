export default {
  ...
  login: {
    ...
    submit: '登录',
    registerTitle: '创建账户',
    registerDescription: '注册一个 Deepseen 账户以继续。',
    ...
    registerCredentialsRequired: '请输入用户名、密码和确认密码',
  ...
  settings: {
    ...
    models: {
      ...
      deepseenDescription: 'Deepseen 跨境工具调用 DeepSeen SDK 时使用的 API Key，覆盖产品报告、竞品调研、达人分析、图片生成、视频生成和视频分析。',
      deepseenPlaceholder: '输入 DEEPSEEN_API_KEY',
      deepseenCurrent: '当前 Key：',
      deepseenSaved: 'DeepSeen API Key 已保存',
      deepseenSaveFailed: 'DeepSeen API Key 保存失败',
    },
    display: {
      streaming: '流式响应',
  ...
  githubPreview: {
    ...
    start: "开启预览",
    stop: "停止",
    note: "预览代码存放在 Web UI 数据目录下。正式环境仍使用 9119，预览开发环境使用前端 8649、后端 9119。",
    path: "预览路径",
    webuiHome: "预览数据目录",
    currentTag: "当前 Tag",
    repoReady: "仓库就绪",
