export default {
  ...
  login: {
    ...
    registerCredentialsRequired: 'Veuillez entrer le nom d\'utilisateur, le mot de passe et sa confirmation',
    invalidCredentials: 'Nom d\'utilisateur ou mot de passe incorrect',
    registerFailed: 'Inscription echouee',
    usernameExists: 'Ce nom d\'utilisateur existe deja',
...
jobTriggered: 'Job declenche',
  ...
  githubPreview: {
    ...
    stop: "Arrêter",
    note: "Le code de prévisualisation est stocké dans le dossier de données Web UI. La production reste sur le port 9119 ; la prévisualisation utilise le frontend 8649 et le backend 9119.",
