export default {
  ...
  login: {
    ...
    registerDescription: 'Register a Deepseen account to continue.',
    ...
    registerCredentialsRequired: 'Please enter username, password, and confirmation password',
  ...
  settings: {
    ...
    models: {
      ...
      deepseenDescription: 'API key used by Deepseen cross-border tools for product reports, competitor research, creator analysis, image generation, video generation, and video analysis.',
      deepseenPlaceholder: 'Enter DEEPSEEN_API_KEY',
      deepseenCurrent: 'Current key:',
      deepseenSaved: 'DeepSeen API key saved',
      deepseenSaveFailed: 'Failed to save DeepSeen API key',
    },
    display: {
  ...
  githubPreview: {
    ...
    start: "Start Preview",
    stop: "Stop",
    note: "Preview code is stored under the Web UI data home. Production remains on port 9119; preview development runs on frontend 8649 and backend 9119.",
    path: "Preview Path",
