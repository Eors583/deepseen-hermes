...
export async function fetchDeepSeenKeyStatus(): Promise<DeepSeenKeyStatus> {
  return request<DeepSeenKeyStatus>('/api/hermes/deepseen-key')
}

export async function saveDeepSeenApiKey(apiKey: string): Promise<DeepSeenKeyStatus> {
  return request<DeepSeenKeyStatus>('/api/hermes/deepseen-key', {
    method: 'PUT',
